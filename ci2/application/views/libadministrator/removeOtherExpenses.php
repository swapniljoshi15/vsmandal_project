...
<div id="wrap">
	...
	<!-- content starts -->
	<div id="">
		<h2 style="text-align:center">Delete Other Expense</h2>
		<form id="removeOtherExpensesForm" method="post" action="<?php echo $expenses->oid;?>">
			<table>
				<tr>
					<td>Expense Description</td>
					<td>
						<textarea name="odesc" rows="4" cols="50" disabled='disabled'>
				...
				<tr>
					...
					<td><input type="textbox" name="oamnt" value="<?php echo $expenses->oamount;?>" disabled='disabled'></td>
				</tr>
				<input type="hidden" name="confirm" value="yes" />
				<tr>
					<td></td>
					<td>
						<button type="submit" id="btn">Delete Expense</button>
					</td>
				</tr>
				<tr>
					<td></td>
