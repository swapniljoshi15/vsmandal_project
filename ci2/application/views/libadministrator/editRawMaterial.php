...
<div id="wrap">
	...
	<!-- content starts -->
	<div id="">
		<h2 style="text-align:center">Edit raw material</h2>
		<form id="editRawMaterialForm" method="post" action="<?php echo $rawMaterial->material_id ?>">
			<table>
				<tr>
					<td>Material Name</td>
					<td><input type="textbox" name="materialname" value="<?php echo $rawMaterial->material_name;?>"></td>
				</tr>
				<tr>
					<td>Material Unit</td>
					<td><input type="textbox" name="materialunit" value="<?php echo $rawMaterial->material_unit;?>"></td>
				</tr>
				<tr>
					<td>Material Reference(Message)</td>
					<td>
						<textarea name="materialref" rows="4" cols="50">
						<?php echo $rawMaterial->material_reference;?>
						</textarea>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="materialStatus" style="width:175px;">
							<?php 
							$selectedActive = '';
							$selectedDeactive = '';
							if($rawMaterial->material_active == 1)$selectedActive="selected='true'";
							if($rawMaterial->material_active == 0)$selectedDeactive="selected='true'";
							?>
