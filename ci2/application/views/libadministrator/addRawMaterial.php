...
<div id="wrap">
	...
	<!-- content starts -->
	<div id="">
		<h2 style="text-align:center">Add raw material</h2>
		<form id="addRawMaterialForm" method="post" action="addRawMaterial">
			<table>
				<tr>
					<td>Material Name</td>
					<td><input type="textbox" name="materialname" value=""></td>
				</tr>
				<tr>
					<td>Material Unit</td>
					<td><input type="textbox" name="materialunit" value=""></td>
				</tr>
				<tr>
