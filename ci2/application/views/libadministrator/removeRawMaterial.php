...
<div id="wrap">
	...
	<!-- content starts -->
	<div id="">
		<h2 style="text-align:center">Delete raw material</h2>
		<form id="removeRawMaterialForm" method="post" action="<?php echo $rawMaterial->material_id ?>">
			<table>
				<tr>
					<td>Material Name</td>
					<td><input type="textbox" name="materialname" value="<?php echo $rawMaterial->material_name;?>" disabled="disabled"></td>
				</tr>
				<tr>
					<td>Material Unit</td>
					<td><input type="textbox" name="materialunit" value="<?php echo $rawMaterial->material_unit;?>" disabled="disabled"></td>
				</tr>
				<tr>
					<td>Material Reference(Message)</td>
					<td>
						<textarea name="materialref" rows="4" cols="50" disabled="disabled">
