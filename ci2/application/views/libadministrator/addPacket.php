...
<div id="wrap">
	...
	<!-- content starts -->
	<div id="">
		<h2 style="text-align:center">Add Packet</h2>
		<form id="addPacketForm" method="post" action="addPacket">
			<table>
				<tr>
					<td>Packet Name</td>
					<td><input type="textbox" name="packetname" value=""></td>
				</tr>
				<tr>
					<td>Packet Quantity</td>
					<td><input type="textbox" name="packetquantity" value=""></td>
				</tr>
				<tr>
					<td>Packet Quantity</td>
					<td>
