...
<div id="wrap">
	...
	<!-- content starts -->
	<div id="">
		<h2 style="text-align:center">Add Utana Group</h2>
		<form id="addUtanaGroupForm" method="post" action="addUtanaGroup">
			<table>
				<tr>
					<td>Group Name</td>
					<td><input type="textbox" name="ugname" value=""></td>
				</tr>
				<tr>
					<td>Group Address</td>
					<td>
				...
				<tr>
					<td>Contact Name</td>
					<td><input type="textbox" name="ugcontactname" value=""></td>
				</tr>
				<tr>
					<td>Contact Phone</td>
					<td><input type="textbox" name="ugcontactno" value=""></td>
				</tr>
				<tr>
					<td></td>
					<td>
