...
<div id="wrap">
	...
	<!-- content starts -->
	<div id="">
		<h2 style="text-align:center">Add Other Expense</h2>
		<form id="addOtherExpensesForm" method="post" action="addOtherExpenses">
			<table>
				<tr>
				...
				<tr>
					...
					<td><input type="textbox" name="oamnt" value=""></td>
				</tr>
				<tr>
					<td></td>
					<td>
