...
<div id="wrap">
	...
	<!-- content starts -->
	<div id="">
		<h2 style="text-align:center">Edit Utana Group</h2>
		<form id="editUtanaGroupForm" method="post" action="<?php echo $utanaGroup->ug_id; ?>">
			<table>
				<tr>
					<td>Group Name</td>
					<td><input type="textbox" name="ugname" value="<?php echo $utanaGroup->ug_name; ?>"></td>
				</tr>
				<tr>
					<td>Group Address</td>
					<td>
						<textarea name="ugaddress" rows="4" cols="50">
				...
				<tr>
					<td>Contact Name</td>
					<td><input type="textbox" name="ugcontactname" value="<?php echo $utanaGroup->ug_contact_name; ?>"></td>
				</tr>
				<tr>
					<td>Contact Phone</td>
					<td><input type="textbox" name="ugcontactno" value="<?php echo $utanaGroup->ug_contact_phone; ?>"></td>
				</tr>
				<tr>
					<td>Group Status</td>
					<td>
						<select name="groupStatus" style="width:175px;">
							<?php 
							$selectedActive = '';
							$selectedDeactive = '';
